                                    ...
                                    <div class="card mb-2">
                                        <div class="card-body" style="background: #a8cc66;">
                                            ...
                                            <form method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="row my-3">
                                                    <div class="col-md-3">
                                                        <label for="serial_No" class="my-2">Tenant</label>
                                                    ...
                                                    <div class="col-md-3">
                                                        <label for="shopNo" class="my-2">Shop No</label>
                                                        <input type="text" name="shopNo" id="shopNo" class="form-control">
                                                    </div>
                                                    ...
                                                    <div class="col-md-3">
                                                        <label for="total_inst" class="my-2">Monthly Rent</label>
                                                    ...
                                                    <div class="col-md-3">
                                                        <label for="advance_amount" class="my-2">Advance</label>
                                                        <input type="text" name="advance_amount" id="advance_amount" class="form-control ">
                                                    </div>
                                                ...
                                                <hr>
                                                <div class="col-md-2">
                                                    <label for="number_installment_upcomming">Payment Number</label>
                                                    <input type="text" name="number_installment_upcomming" id="number_installment_upcomming" class="form-control">
                                                </div>
                                                <div class="row my-3">
                                                    {{-- <h4>Payment Information</h4>
                                                    <div class="col-md-6">
                                                        <label for="branch_name" class="my-2">Paid</label>
                                                        <input type="text" name="invpaid" id="invPaid" class="form-control" readonly>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label for="branch_name" class="my-2">Due</label>
                                                        <input type="text" name="invdue" id="invDue" class="form-control" readonly>
                                                    </div> --}}
                                                    <h4 style="color: rgb(143, 13, 13)" id="unpaidMonth"></h4>
                                                        ...
                                                        <table class="table table-stipe table-bordered table-hover">
                                                            ...
                                                            <tbody id="paymentTable">
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <input type="text" class="form-control" name="total" id="GrandTotal">
                                                                    </td>
                                                                    <td>
                                                                        <input type="hidden" class="form-control" name="quarterly" id="quarterly">
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                            <tfoot>
                                                                <tr>
                                                                    ...
                                                                    <td colspan="4" id="GrandTotal_1">Total = </td>
                                                                </tr>
                                                            </tfoot>
                                                        </table>
                                                    </div>
        ...
        $('#serial_No').change(function() {
            ...
            $.ajax({
                ...
                , success: function(data) {
                    ...
                    // $('#monthly_rent').val(data[0].monthly_rent);
                    $('#per_int_amount').val(data[0].monthly_rent);
                    $('#advance_amount').val(data[0].advance_amount);
