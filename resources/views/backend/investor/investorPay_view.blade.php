    ...
    <div style="margin:50px auto;width:1000px;border:1px solid #ddd;padding:5px;border-radius:10px;">
        <div style="margin:0 0 30px 0">
            ...
            <div style="width: 24%;display:inline-block;">
                <h3 style="font-size: 20px">Payment No: {{ $investorPay->id ?? '' }}</h3>
            </div>
        ...
        <div style="margin:0 auto;width:88%;">
            {{-- <div >
                <p style="font-size: 20px;line-height:2;">Received with thanks form Mr/Ms <strong>@if ($investorPay->investor->name   ){{ $investorPay->investor->name }} @else ............................ @endif</strong> against Ownership Id/Membership<br>
                No : <strong>@if ($investorPay->investor->serial_number   ){{ $investorPay->investor->serial_number }} @else ............................ @endif</strong> Unit :<strong>@if ($investorPay->investor->no_ownership   ){{ $investorPay->investor->no_ownership }} @else ............................ @endif</strong>Project of Chuti Resort Purbachal<strong>@if ($investorPay->investor->project_name   ){{ $investorPay->investor->project_name }} @else ........................................ @endif</strong><br>
                Tk. <strong>@if ($investorPay->total ){{ $investorPay->total}} Tk. @else ............................ @endif</strong>as  installment No. <strong>@if ($investorPay->number_installment_upcomming   ){{ $investorPay->number_installment_upcomming }} @else ............................ @endif</strong><br>
               by Cash/ Cheque/ Online Payment <strong>@if($investorPay->payment_type){{ $investorPay->payment_type }}@else.................
               @endif</strong> Date: <strong>@if ($investorPay->created_at ){{ $investorPay->created_at->format('d-M-Y')}}  @else ............................ @endif</strong>Chq No : <strong>@if ($investorPay->chqNo){{ $investorPay->chqNo }}@else ............@endif</strong><br>
            ...
            <div>
                <p style="font-size: 20px;line-height:2;">Received with thanks form Mr/Ms <strong>@if ($investorPay->investor->name ){{ $investorPay->investor->name }} @else ............................ @endif</strong> 
                    Monthly paid amount  <strong>@if ($investorPay->total ){{ $investorPay->total}} Tk. @else ............................ @endif</strong>Date: <strong>@if ($investorPay->created_at ){{ $investorPay->created_at->format('d-M-Y')}} @else ............................ @endif</strong>
                    by Cash/ Cheque/ Online Payment : <strong>@if($investorPay->payment_type){{ $investorPay->payment_type }}@else.................
