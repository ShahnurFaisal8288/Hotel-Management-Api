            ...
            <div class="card">
                <div class="card-body" style="background: #a8cc66;">
                    ...
                    <div class="customer-card">
                        ...
                        <a href="{{route('lead')}}" class="btn btn-primary">Lead List</a>
                    </div>
                    <form method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group my-2">
                            <label for="name">Name</label>
                            <input class="form-control" type="text" value="{{$lead->full_name}}" name="full_name" id="name" placeholder="Enter Name">
                        </div>
                        <div class="form-group my-2">
                        ...
                        <div class="form-group my-2">
                            ...
                            <input class="form-control" type="text" value="{{$lead->phone_number}}" name="phone_number" id="phone" placeholder="Enter Phone">
                        </div>
                        ...
                        <div class="form-group my-2">
                            ...
                            <select class="select2-multiple form-control" name="sales_officer" id="sales_officer" multiple>
                                <option value="">Select Sales Officer</option>
                                @foreach($employees as $employee)
                                <option value="{{ $employee->id }}" {{ in_array($employee->id, explode(',', $lead->sales_officer)) ? 'selected' : '' }}>
                                    {{ $employee->name }}
                                </option>
                                @endforeach
                            </select>
